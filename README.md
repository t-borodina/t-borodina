...
- Навыки работы с SQL, включая вложенные запросы, оконные функции и конструкции case
- Создание дашбордов, в том числе с помощью Tableau
- Расчет ключевых метрик продукта, таких как ARPU, ARPPU, retention, conversion и churn rate
